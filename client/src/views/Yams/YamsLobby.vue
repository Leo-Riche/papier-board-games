  ...
  <div class="lobby-wrapper">
    <header class="lobby-header">
      <div class="engraved-panel">
        <h1 class="game-title">YAMS 🎲</h1>
        <p class="subtitle">Le jeu de dés classique</p>
      </div>
    </header>
...
const joinRoom = () => {
  ...
  router.push(`/yams/game/${roomCode.value}`)
}
</script>
...
.lobby-wrapper {
  ...
  background: #0f1a0f; color: #ecf0f1; font-family: 'Outfit', sans-serif;
}
...
.subtitle { color: #7a9a7a; font-size: 1.1rem; font-weight: 700; letter-spacing: 2px; text-transform: uppercase; margin-top: 10px; }
...
.input-group input {
  width: 100%; padding: 15px; background: #243524; border: 2px solid transparent; border-radius: 10px;
  color: #ecf0f1; font-family: 'Outfit', sans-serif; font-size: 1.1rem; text-align: center; outline: none; transition: 0.3s;
  box-sizing: border-box;
}
.input-group input::placeholder { color: #7a9a7a; }
.input-group input:focus { border-color: #d4af37; background: #1a2e1a; }
...
.action-btn.primary { background: linear-gradient(135deg, #d4af37, #b8962e); color: #1a1a1a; }
.action-btn.primary:hover { background: linear-gradient(135deg, #f5d670, #d4af37); transform: translateY(-2px); box-shadow: 0 5px 15px rgba(212, 175, 55, 0.4); }
.action-btn.secondary { background: #243524; color: #bdc3c7; border: 2px solid #7a9a7a; }
.action-btn.secondary:hover { background: #2d4a2d; color: white; transform: translateY(-2px); border-color: #d4af37;}
